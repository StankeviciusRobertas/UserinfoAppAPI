...
namespace UserinfoApp.DAL.Migrations
{
    ...
    partial class UserinfoAppDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserinfoApp.DAL.Entities.Image", b =>
                {
                    b.HasOne("UserinfoApp.DAL.Entities.UserInfo", "UserInfo")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("UserinfoApp.DAL.Entities.UserAdress", b =>
                {
                    b.HasOne("UserinfoApp.DAL.Entities.UserInfo", "UserInfo")
                        .WithOne("UserAdress")
                        .HasForeignKey("UserinfoApp.DAL.Entities.UserAdress", "UserInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
